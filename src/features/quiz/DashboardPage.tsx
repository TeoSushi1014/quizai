...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-10 md:space-y-12">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-5 border-b border-slate-700/50 pb-8 sm:pb-10">
        ...
        <div className="flex flex-wrap gap-3 sm:gap-4">
          <Button 
            ...
            className="shadow-xl hover:shadow-sky-400/50 transform hover:scale-105 py-3 px-6 rounded-xl"
          >
      ...
      {isLoading ? (
         <div className="text-center py-24 sm:py-28">
            {/* You can put a loading spinner here if needed */}
            <p className="text-slate-300">{t('loading')}</p>
         </div>
      ) : sortedQuizzes.length === 0 ? (
        <div className="text-center py-24 sm:py-28 bg-slate-800 rounded-3xl shadow-2xl border border-slate-700/70 glass-effect">
